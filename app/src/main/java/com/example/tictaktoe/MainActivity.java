...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        abt3 = findViewById(R.id.bt3);
        abt4 = findViewById(R.id.bt4);
        abt5 = findViewById(R.id.bt5);
        abt6 = findViewById(R.id.bt6);
        abt7 = findViewById(R.id.bt7);
        abt8 = findViewById(R.id.bt8);
